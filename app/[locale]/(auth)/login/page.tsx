...
type NormalLoginForm = z.infer<typeof normalLoginSchema>;
...
export default function LoginPage() {
  ...
  const onSubmitNormal: SubmitHandler<NormalLoginForm> = async (data) => {
    console.log(data);
  };
            ...
            <Field>
              ...
              <FieldContent>
                <div className="space-y-1">
                  ...
                  {errorsPhone.phone && (
                    <ErrorMsg>{errorsPhone.phone.message}</ErrorMsg>
                  )}
                </div>
              </FieldContent>
            </Field>
